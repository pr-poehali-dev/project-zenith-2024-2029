...
def generate_sample_plan(year: int, month: int) -> bytes:
    ...
    # 12 устройств — чтобы на каждый день приходилось не менее 10 работ
    devices = [
        ("Участок №1", "АЛС-1", "ПК 12+450"),
        ("Участок №1", "АЛС-2", "ПК 18+200"),
        ("Участок №1", "САУТ-Ц", "ПК 20+100"),
        ("Участок №2", "ТСКБМ", "ст. Северная"),
        ("Участок №2", "КЛУБ-У", "ПК 24+100"),
        ("Участок №2", "УКСПС", "ПК 26+550"),
        ("Участок №3", "АЛСН", "ст. Южная"),
        ("Участок №3", "САУТ-ЦМ", "ПК 30+780"),
        ("Участок №3", "ДИСК-Б", "ПК 33+200"),
        ("Участок №4", "КТСМ-02", "ст. Восточная"),
        ("Участок №4", "УКПТ", "ПК 38+640"),
        ("Участок №4", "ПОНАБ", "ст. Западная"),
    ]
